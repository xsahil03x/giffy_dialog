...
class NetworkPortraitMode extends StatelessWidget {
  const NetworkPortraitMode({
    Key key,
...
class NetworkLandscapeMode extends StatelessWidget {
  const NetworkLandscapeMode({
    Key key,
    @required this.cornerRadius,
    @required this.image,
    @required this.title,
