...
/// Giffy Dialog using local asset.
///
/// You need local asset for this type Giffy Dialog.  
...
class AssetGiffyDialog extends StatelessWidget {
  ...
  ///
  /// Pass `Image.asset(name)` widget here. Preferably with `fit: BoxFit.cover` property.
