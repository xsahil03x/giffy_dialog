...
void main() {
  group(
    'Dialog Assertion Test',
    () {
      testWidgets(
        'AssetGiffyDialog throws if initialized with null image',
      ...
      testWidgets(
        'AssetGiffyDialog throws if initialized with null title',
        (WidgetTester tester) async {
          try {
            await tester.pumpWidget(
              AssetGiffyDialog(
      ...
      testWidgets(
        'NetworkGiffyDialog throws if initialized with null image',
        (WidgetTester tester) async {
          try {
            await tester.pumpWidget(
              NetworkGiffyDialog(
      ...
      testWidgets(
        'NetworkGiffyDialog throws if initialized with null title',
        (WidgetTester tester) async {
          try {
            await tester.pumpWidget(
              NetworkGiffyDialog(
  ...
  group(
    'Dialog Smoke and Orientation Test',
    () {
      testWidgets(
        'Check Portrait Dialog test',
        (WidgetTester tester) async {
